...
function buildAuraSpeckles(hex, palette, canvasWidth, canvasHeight) {
  const random = createSeededRandom(`${hex}-balanced`);
  const speckles = [];
...
const idBase = 'poster-stage-aura-ajinkya-balanced';
...
fs.writeFileSync(path.join(outputDir, 'ajinkya-feed-aura-balanced-1080x2340.svg'), svg);
